...
class Strategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        #bt.indicators.FibonacciPivotPoint(self.data1)
        bt.indicators.AdaptiveMovingAverage(self.datas[0], period=38)
        bt.indicators.AdaptiveMovingAverage(self.datas[0], period=56)
        bt.indicators.AdaptiveMovingAverage(self.datas[0], period=72)
