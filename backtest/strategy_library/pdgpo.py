...
class Strategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.pd = bt.indicators.PlusDirectionalIndicator(self.datas[0])
    ...
    def next(self):
        ...
        BUY_SIGNAL = self.pgo[0] < -2.5 and self.pd.plusDI[0] < 15.0
        SELL_SIGNAL = self.pd.plusDI[0] >= 30.0 or self.rsi[0] >= 70.0
