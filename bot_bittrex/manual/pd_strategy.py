...
import pandas as pd
import numpy as np
import bittrex_func as _BITTREX
...
btt = _BITTREX.getCandleList('BTC-DCR', 'hour')

data = {'Date': btt['t'], 'Open': btt['o'], 'High': btt['h'], 'Low': btt['l'], 'Close': btt['c'], 'Volume': btt['v']}

df = pd.DataFrame(data=data)
#print(df)

print(vortex_indicator(df, 14).Vortex_14.iloc[-10])
print(vortex_indicator(df, 14).Date.iloc[-30])