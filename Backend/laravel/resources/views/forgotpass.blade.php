        ...
        <div class="col-xl-6 push-xl-3 col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-10 push-sm-1 login_section">
            <div class="row">
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12 login2_border login_section_top">
                    ...
                    <div class="m-t-15">
                        <form method="POST" action="{{ route('email.password.post') }}" id="login_validator">
                            {{ csrf_field() }}
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-success btn-block b_r_20 m-t-20">ENVIAR EMAIL</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div class="text-center">
                            <a href="{{route('login')}}">
                                <button class="btn btn-success btn-block b_r_20 m-t-20">VOLTAR</button>
                            </a>
                        </div>
                        Um link de recuperação de senha será enviado ao seu e-mail.
                        @if($errors->any())
