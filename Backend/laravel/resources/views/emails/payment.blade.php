                                          ...
                                          <tr>
                                             <td style="border-collapse: collapse;">
                                                <h2 style="font-weight: normal; margin: 0px; padding:
                                                   ...
                                                   width: 100%; color: #666;">Fatura</span></a>
                                                </h2>
                                             </td>
                                          </tr>
                                       </tbody>
                                             ...
                                             <td style="border-collapse:
                                                ...
                                                <div style="font-family: Arial;
                                                   ...
                                                   <div style="text-align:
                                                      center;">Olá, clique no link abaixo para acessar a fatura que você gerou no site, caso o status da fatura esteja como <b>"Cancelado/Tempo Esgotado"</b> por favor não envie o valor e gere uma nova fatura.  <span style="line-height: 0;
                                          ...
                                          <tbody style="display:
                                             ...
                                             <tr style="display:
                                                ...
                                                <td align="center" style="border-collapse: collapse; display:
                                                   inline-block; padding: 10px 10px;"><a target="_blank" style="display: inline-block;
                                                   text-decoration: none; box-sizing: border-box;
                                                   font-family: arial; color: #fff; font-size: 15px;
                                                   font-weight: bold; margin: 0px; padding: 0px;
                                                   text-align: center; word-wrap: break-word; width:
                                                   100%; cursor: text;"><a style="color:white;" href="{{ $link }}">Pagar
                                                   </a></td>
                                             </tr>
                                          </tbody>
                                       </table>
                                             ...
                                             <td style="border-collapse:
                                                ...
                                                <div style="font-family: Arial;
                                                   ...
                                                   <div style="text-align:
                                                      ...
                                                      rgb(120,113,99);"></span>Protraderbot - Robo de Trading para Criptomoedas
                                                   </div>
                                                    <a style="text-align: center;display:block; color:
                                                    rgb(120,113,99);" href="mailto:contato@protraderbot.com">
                                                    protraderbot.com
                                                    </a>
                                                </div>
                                             </td>
