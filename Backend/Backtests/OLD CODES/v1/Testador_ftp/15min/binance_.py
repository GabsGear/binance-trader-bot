...
class Binance_opr:
    ...
    def getCandles(self, coin):
        candles = client.get_klines(symbol= coin, interval=Client.KLINE_INTERVAL_15MINUTE)
    ...
    def getStoricalCandles(self, coin, day):
        ...
        klines = client.get_historical_klines(coin, Client.KLINE_INTERVAL_15MINUTE, "1 Jan, 2017", "1 Mar, 2018")
