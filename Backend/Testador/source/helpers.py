...
class Helpers:
    ...
    #% de Ganhos = (Nº de Ganhos) / (Nº de Operações)
    ...
    def generateFinalLog(self, strategy, log, coin, begin, end, ncandles):
        ...
        file = open('/home/gabs/logs/FinalLog/'+str(strategy)+'-'+ str(coin)+'-Final-output.txt', 'a+')
        file.write(self.returnHashtag()) 
        file.write('                    Relatório de Análise de estratégia\n\n\n')
        file.write('Nome da estragégia : ' + str(strategy)+ '\n')
        file.write('Moeda Analisada: ' + str(coin) + '\n\n') 
        file.write('Data da análise: ' + str(self.time_now())+'\n')           
        file.write('Início da análise: ' + str(begin)+ '\n')
        file.write('Final da análise: ' + str(end)+ '\n') 
        file.write(self.returnHashtag())  
        ...
        file.write('Número de StopLoss = ' + str(log[5]) + '\n\n')
        file.write('Final da análise\n')                    
        file.write(self.returnHashtag()) 
